...
class Crawler:
    def __init__(self):
        ...
        self.__music_url = "https://music.163.com/#/search/m/?s="
    ...
    def getmusic(self, music_name):
        self.__music_url = "https://music.163.com/#/search/m/?s="
        self.__music_url = self.__music_url + music_name + "&type=1"
    ...
    def getouterurl(self):
        ...
        if item_list:
            ...
            return self.outer_base_url + self.__music_id
        else:
            print("无搜索结果!")
            self.__music_id = ""
    ...
    def getlyrics(self):
        if self.driver and self.__music_exist:
            self.driver.get("https://music.163.com/#/song?id="+self.__music_id)
            self.driver.switch_to.frame('contentFrame')
            print("https://music.163.com/#/song?id="+self.__music_id)
